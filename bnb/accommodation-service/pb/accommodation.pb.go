...
var file_accommodation_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6d, 0x73, 0x67, 0x32, 0xec, 0x01, 0x0a, 0x14, 0x41, 0x63,
	...
	0x74, 0x69, 0x6f, 0x6e, 0x22, 0x00, 0x30, 0x01, 0x42, 0x3f, 0x5a, 0x3d, 0x67, 0x69, 0x74, 0x68,
	...
	0x2f, 0x61, 0x63, 0x63, 0x6f, 0x6d, 0x6d, 0x6f, 0x64, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2d, 0x73,
...
var file_accommodation_proto_msgTypes = make([]protoimpl.MessageInfo, 4)
...
var file_accommodation_proto_depIdxs = []int32{
	4, // 0: pb.Accommodation.availabilityStartDate:type_name -> google.protobuf.Timestamp
	4, // 1: pb.Accommodation.availabilityEndDate:type_name -> google.protobuf.Timestamp
	4, // 2: pb.Accommodation.priceStartDate:type_name -> google.protobuf.Timestamp
	4, // 3: pb.Accommodation.priceEndDate:type_name -> google.protobuf.Timestamp
	...
	3, // 7: pb.AccommodationService.TestConnection:output_type -> pb.TestMessage
	0, // 8: pb.AccommodationService.GetAccommodationById:output_type -> pb.Accommodation
	0, // 9: pb.AccommodationService.GetAccommodationByHostId:output_type -> pb.Accommodation

...
var file_reservation_proto_rawDesc = []byte{
	...
	0xd0, 0x02, 0x0a, 0x12, 0x52, 0x65, 0x73, 0x65, 0x72, 0x76, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x53,
...
var file_reservation_proto_depIdxs = []int32{
	...
	0, // 6: pb.ReservationService.GetReservationById:output_type -> pb.Reservation
	0, // 7: pb.ReservationService.GetReservationsByAccommodationId:output_type -> pb.Reservation
	0, // 8: pb.ReservationService.GetActiveReservationsByUser:output_type -> pb.Reservation
	0, // 9: pb.ReservationService.GetFutureActiveReservationsByHost:output_type -> pb.Reservation

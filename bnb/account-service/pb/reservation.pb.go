...
var file_reservation_proto_rawDesc = []byte{
	...
	0x0d, 0x0a, 0x0b, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x52, 0x65, 0x73, 0x4d, 0x73, 0x67, 0x22, 0x1f,
	0x0a, 0x0b, 0x50, 0x69, 0x6e, 0x67, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x12, 0x10, 0x0a,
	0x03, 0x6d, 0x73, 0x67, 0x18, 0x01, 0x20, 0x01, 0x28, 0x09, 0x52, 0x03, 0x6d, 0x73, 0x67, 0x32,
	0x81, 0x04, 0x0a, 0x12, 0x52, 0x65, 0x73, 0x65, 0x72, 0x76, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x53,
	...
	0x69, 0x6f, 0x6e, 0x22, 0x00, 0x30, 0x01, 0x12, 0x2a, 0x0a, 0x04, 0x50, 0x69, 0x6e, 0x67, 0x12,
	0x0f, 0x2e, 0x70, 0x62, 0x2e, 0x45, 0x6d, 0x70, 0x74, 0x79, 0x52, 0x65, 0x73, 0x4d, 0x73, 0x67,
	0x1a, 0x0f, 0x2e, 0x70, 0x62, 0x2e, 0x50, 0x69, 0x6e, 0x67, 0x4d, 0x65, 0x73, 0x73, 0x61, 0x67,
	0x65, 0x22, 0x00, 0x42, 0x3d, 0x5a, 0x3b, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63, 0x6f,
	0x6d, 0x2f, 0x72, 0x72, 0x75, 0x7a, 0x69, 0x63, 0x69, 0x63, 0x2f, 0x67, 0x6c, 0x6f, 0x62, 0x65,
	0x74, 0x72, 0x6f, 0x74, 0x74, 0x65, 0x72, 0x2f, 0x62, 0x6e, 0x62, 0x2f, 0x72, 0x65, 0x73, 0x65,
	0x72, 0x76, 0x61, 0x74, 0x69, 0x6f, 0x6e, 0x2d, 0x73, 0x65, 0x72, 0x76, 0x69, 0x63, 0x65, 0x2f,
...
var file_reservation_proto_goTypes = []interface{}{
	...
	(*PingMessage)(nil),                          // 5: pb.PingMessage
...
var file_reservation_proto_depIdxs = []int32{
	...
	4, // 8: pb.ReservationService.Ping:input_type -> pb.EmptyResMsg
	0, // 9: pb.ReservationService.GetAllReservations:output_type -> pb.Reservation
	0, // 10: pb.ReservationService.GetReservationById:output_type -> pb.Reservation
	0, // 11: pb.ReservationService.GetReservationsByAccommodationId:output_type -> pb.Reservation
	0, // 12: pb.ReservationService.GetActiveReservationsByUser:output_type -> pb.Reservation
	0, // 13: pb.ReservationService.GetFutureActiveReservationsByHost:output_type -> pb.Reservation
	0, // 14: pb.ReservationService.GetFinishedReservationsByUser:output_type -> pb.Reservation
	5, // 15: pb.ReservationService.Ping:output_type -> pb.PingMessage
